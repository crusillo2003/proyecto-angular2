        ...
        execute: function() {
            RestauranteAddComponent = (function () {
                ...
                RestauranteAddComponent.prototype.ngOnInit = function () {
                    this.restaurante = new Restaurante_1.Restaurante(0, this._routeParams.get("nombre") ? this._routeParams.get("nombre") : "Nuevo Restaurante", this._routeParams.get("direccion") ? this._routeParams.get("direccion") : "Nueva direccion", this._routeParams.get("imagen") ? this._routeParams.get("imagen") : "imagen", this._routeParams.get("descripcion") ? this._routeParams.get("descripcion") : "Nueva descripcion", this._routeParams.get("precio") ? this._routeParams.get("precio") : "bajo");
                ...
                RestauranteAddComponent.prototype.fileChangeEvent = function (fileInput) {
                    ...
                    this.makeFileRequest("http://localhost/proyecto-angular/slim/api.php/upload", [], this.filesToUpload).then(function (result) {
                        _this.resultUpload = result;
                        _this.restaurante.imagen = _this.resultUpload.filename;
                        console.log("imagen result: " + _this.restaurante.imagen);
                    }, function (error) {
